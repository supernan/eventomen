...
namespace tools
{
	...
	class UtilInterface
	{
		public:
			 ...
			 */
            static void sentence_cut(std::string src, std::vector<std::string> &seps, std::vector<std::string> &res);
	...
	{
		public:
			WordSegThreadPool(const string &ict_conf, int thread_num, std::map<int, WeiboTopic_ICT::Weibo> &id_doc_map);
